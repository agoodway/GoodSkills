---
description: Refactor code for improved quality, reduced complexity, and better maintainability using proven patterns and measurable metrics
mode: subagent
...
## Outputs
- **Refactoring Reports**: Before/after complexity metrics with improvement analysis
- **Code Transformations**: Systematic refactoring implementations with change documentation
